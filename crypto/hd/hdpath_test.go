...
import (
	...
	bip39 "github.com/soominhyunwoo/go-bip39"
...
// See issue https://github.com/soominhyunwoo/chain-sdk/issues/7627.
...
func ExampleSomeBIP32TestVecs() {
	...
	master, ch := hd.ComputeMastersFromSeed(seed)
	fmt.Println("keys from fundraiser test-vector (soominhyunwoo, bitcoin, ether)")
	fmt.Println()
	// soominhyunwoo
	...
	// Output: keys from fundraiser test-vector (soominhyunwoo, bitcoin, ether)
	//
...
// See issue https://github.com/soominhyunwoo/chain-sdk/issues/8557.
