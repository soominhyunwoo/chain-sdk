...
// source: soominhyunwoo/crypto/multisig/v1beta1/multisig.proto
...
// See soominhyunwoo.tx.v1betata1.ModeInfo.Multi for how to specify which signers
...
func init() {
	proto.RegisterType((*MultiSignature)(nil), "soominhyunwoo.crypto.multisig.v1beta1.MultiSignature")
	proto.RegisterType((*CompactBitArray)(nil), "soominhyunwoo.crypto.multisig.v1beta1.CompactBitArray")
}

func init() {
	proto.RegisterFile("soominhyunwoo/crypto/multisig/v1beta1/multisig.proto", fileDescriptor_1177bdf7025769be)
}
