...
import (
	...
	tmsecp256k1 "github.com/soominhyunwoo/tendermint/crypto/secp256k1"
...
func TestGenPrivKeyFromSecret(t *testing.T) {
	...
	tests := []struct {
		...
		{"another seed used in soominhyunwoo tests #1", []byte{0}},
		{"another seed used in soominhyunwoo tests #2", []byte("mySecret")},
		{"another seed used in soominhyunwoo tests #3", []byte("")},
	}
