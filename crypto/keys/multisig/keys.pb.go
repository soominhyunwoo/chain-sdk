...
// source: soominhyunwoo/crypto/multisig/keys.proto
...
func init() {
	proto.RegisterType((*LegacyAminoPubKey)(nil), "soominhyunwoo.crypto.multisig.LegacyAminoPubKey")
}

func init() {
	proto.RegisterFile("soominhyunwoo/crypto/multisig/keys.proto", fileDescriptor_46b57537e097d47d)
}
