...
import (
	...
	"github.com/soominhyunwoo/chain-sdk/codec/legacy"
	...
	"github.com/soominhyunwoo/chain-sdk/crypto/types/multisig"
...
func TestDisplay(t *testing.T) {
	...
	require.NoError(err)
	expectedPrefix := `{"@type":"/soominhyunwoo.crypto.multisig.LegacyAminoPubKey","threshold":2,"public_keys":[{"@type":"/soominhyunwoo.crypto.secp256k1.PubKey"`
	require.True(strings.HasPrefix(string(bz), expectedPrefix))
	// Example output:
	// {"@type":"/soominhyunwoo.crypto.multisig.LegacyAminoPubKey","threshold":2,"public_keys":[{"@type":"/soominhyunwoo.crypto.secp256k1.PubKey","key":"AymUY3J2HKIyy9cbpGKcBFUTuDQsRH9NO/orKF/0WQ76"},{"@type":"/soominhyunwoo.crypto.secp256k1.PubKey","key":"AkvnCDzSYF+tQV/FoI217V7CDIRPzjJj7zBE2nw7x3xT"},{"@type":"/soominhyunwoo.crypto.secp256k1.PubKey","key":"A0yiqgcM5EB1i0h79+sQp+C0jLPFnT3+dFmdZmGa+H1s"}]}
}
...
func TestAminoUnmarshalJSON(t *testing.T) {
	...
	// ref: https://github.com/soominhyunwoo/chain-sdk/issues/8776
	pkJSON := `{
