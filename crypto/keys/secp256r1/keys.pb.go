...
// source: soominhyunwoo/crypto/secp256r1/keys.proto
...
func (*PubKey) XXX_MessageName() string {
	return "soominhyunwoo.crypto.secp256r1.PubKey"
}
...
func (*PrivKey) XXX_MessageName() string {
	return "soominhyunwoo.crypto.secp256r1.PrivKey"
}
func init() {
	proto.RegisterType((*PubKey)(nil), "soominhyunwoo.crypto.secp256r1.PubKey")
	proto.RegisterType((*PrivKey)(nil), "soominhyunwoo.crypto.secp256r1.PrivKey")
}

func init() {
	proto.RegisterFile("soominhyunwoo/crypto/secp256r1/keys.proto", fileDescriptor_b90c18415095c0c3)
}
