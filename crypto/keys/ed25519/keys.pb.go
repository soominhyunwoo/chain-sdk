...
// source: soominhyunwoo/crypto/ed25519/keys.proto
...
func init() {
	proto.RegisterType((*PubKey)(nil), "soominhyunwoo.crypto.ed25519.PubKey")
	proto.RegisterType((*PrivKey)(nil), "soominhyunwoo.crypto.ed25519.PrivKey")
}

func init() {
	proto.RegisterFile("soominhyunwoo/crypto/ed25519/keys.proto", fileDescriptor_48fe3336771e732d)
}
