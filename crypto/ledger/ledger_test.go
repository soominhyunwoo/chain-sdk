...
import (
	...
	"github.com/soominhyunwoo/chain-sdk/crypto/types"
...
func checkDefaultPubKey(t *testing.T, priv types.LedgerPrivKey) {
	...
	require.Equal(t, "soominhyunwoo1w34k53py5v5xyluazqpq65agyajavep2rflq6h",
...
func TestPublicKeySafe(t *testing.T) {
	path := *hd.NewFundraiserParams(0, sdk.CoinType, 0)
	priv, addr, err := NewPrivKeySecp256k1(path, "soominhyunwoo")
...
func TestPublicKeyHDPath(t *testing.T) {
	...
	expectedAddrs := []string{
		"soominhyunwoo1w34k53py5v5xyluazqpq65agyajavep2rflq6h",
		"soominhyunwoo19ewxwemt6uahejvwf44u7dh6tq859tkyvarh2q",
		"soominhyunwoo1a07dzdjgjsntxpp75zg7cgatgq0udh3pcdcxm3",
		"soominhyunwoo1qvw52lmn9gpvem8welghrkc52m3zczyhlqjsl7",
		"soominhyunwoo17m78ka80fqkkw2c4ww0v4xm5nsu2drgrlm8mn2",
		"soominhyunwoo1ferh9ll9c452d2p8k2v7heq084guygkn43up9e",
		"soominhyunwoo10vf3sxmjg96rqq36axcphzfsl74dsntuehjlw5",
		"soominhyunwoo1cq83av8cmnar79h0rg7duh9gnr7wkh228a7fxg",
		"soominhyunwoo1dszhfrt226jy5rsre7e48vw9tgwe90uerfyefa",
		"soominhyunwoo1734d7qsylzrdt05muhqqtpd90j8mp4y6rzch8l",
	}
