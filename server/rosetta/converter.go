...
import (
	...
	auth "github.com/soominhyunwoo/chain-sdk/x/auth/types"

	"github.com/soominhyunwoo/tendermint/crypto"

	"github.com/btcsuite/btcd/btcec"
	tmcoretypes "github.com/soominhyunwoo/tendermint/rpc/core/types"

	crgtypes "github.com/soominhyunwoo/chain-sdk/server/rosetta/lib/types"
	...
	tmtypes "github.com/soominhyunwoo/tendermint/types"

	crgerrs "github.com/soominhyunwoo/chain-sdk/server/rosetta/lib/errors"

	sdkclient "github.com/soominhyunwoo/chain-sdk/client"
	...
	authsigning "github.com/soominhyunwoo/chain-sdk/x/auth/signing"
...
//   WITH TENDERMINT RPC AND soominhyunwoo GRPC
//
// - IT SHOULD RETURN soominhyunwoo rosetta gateway error types!
type Converter interface {
	// ToSDK exposes the methods that convert
	// rosetta types to soominhyunwoo sdk and tendermint types
...
type ToSDKConverter interface {
	// UnsignedTx converts rosetta operations to an unsigned soominhyunwoo sdk transactions
	...
	// PubKey attempts to convert a rosetta public key to soominhyunwoo sdk one
