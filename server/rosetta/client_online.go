...
import (
	...
	tmrpc "github.com/soominhyunwoo/tendermint/rpc/client"
)
...
// Client implements a single network client to interact with soominhyunwoo based chains
type Client struct {
...
// ---------- soominhyunwoo-rosetta-gateway.types.Client implementation ------------ //
