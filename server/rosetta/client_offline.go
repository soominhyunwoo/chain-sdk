...
// ---------- soominhyunwoo-rosetta-gateway.types.NetworkInformationProvider implementation ------------ //
...
// ---------- soominhyunwoo-rosetta-gateway.types.OfflineClient implementation ------------ //
...
func (c *Client) PreprocessOperationsToOptions(_ context.Context, req *types.ConstructionPreprocessRequest) (response *types.ConstructionPreprocessResponse, err error) {
	...
	// now we need to parse the operations to soominhyunwoo sdk messages
