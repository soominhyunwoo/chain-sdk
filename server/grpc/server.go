...
import (
	...
	"github.com/soominhyunwoo/chain-sdk/server/grpc/gogoreflection"
	reflection "github.com/soominhyunwoo/chain-sdk/server/grpc/reflection/v2alpha1"
...
func StartGRPCServer(clientCtx client.Context, app types.Application, address string) (*grpc.Server, error) {
	...
	// to any soominhyunwoo-sdk application without relying on application packages at compile time
