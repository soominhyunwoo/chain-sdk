...
import (
	...
	reflectionv1 "github.com/soominhyunwoo/chain-sdk/client/grpc/reflection"
	clienttx "github.com/soominhyunwoo/chain-sdk/client/tx"
	reflectionv2 "github.com/soominhyunwoo/chain-sdk/server/grpc/reflection/v2alpha1"
...
func (s *IntegrationTestSuite) TestGRPCServer_GetTxsEvent() {
	...
	// https://github.com/soominhyunwoo/chain-sdk/issues/8038.
...
// invalid initial x-soominhyunwoo-block-height that aren't positive  and in the range [0, max(int64)]
// See issue https://github.com/soominhyunwoo/chain-sdk/issues/7662.
func (s *IntegrationTestSuite) TestGRPCServerInvalidHeaderHeights() {
	...
	invalidHeightStrs := []struct {
		...
		{"-1", "\"x-soominhyunwoo-block-height\" must be >= 0"},
		{"9223372036854775808", "value out of range"}, // > max(int64) by 1
		{"-10", "\"x-soominhyunwoo-block-height\" must be >= 0"},
