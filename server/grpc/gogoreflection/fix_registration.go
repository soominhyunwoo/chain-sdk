...
import (
	...
	_ "github.com/soominhyunwoo/chain-proto" // look above
)

var importsToFix = map[string]string{
	"gogo.proto":          "gogoproto/gogo.proto",
	"soominhyunwoo.proto": "soominhyunwoo_proto/soominhyunwoo.proto",
}
...
// Currently every soominhyunwoo-sdk proto file is importing gogo.proto as gogoproto/gogo.proto,
// but gogo.proto registers itself as gogo.proto, same goes for soominhyunwoo.proto.
