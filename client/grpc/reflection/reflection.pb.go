...
// source: soominhyunwoo/base/reflection/v1beta1/reflection.proto
...
func init() {
	proto.RegisterType((*ListAllInterfacesRequest)(nil), "soominhyunwoo.base.reflection.v1beta1.ListAllInterfacesRequest")
	proto.RegisterType((*ListAllInterfacesResponse)(nil), "soominhyunwoo.base.reflection.v1beta1.ListAllInterfacesResponse")
	proto.RegisterType((*ListImplementationsRequest)(nil), "soominhyunwoo.base.reflection.v1beta1.ListImplementationsRequest")
	proto.RegisterType((*ListImplementationsResponse)(nil), "soominhyunwoo.base.reflection.v1beta1.ListImplementationsResponse")
}

func init() {
	proto.RegisterFile("soominhyunwoo/base/reflection/v1beta1/reflection.proto", fileDescriptor_d48c054165687f5c)
}
...
func (c *reflectionServiceClient) ListAllInterfaces(ctx context.Context, in *ListAllInterfacesRequest, opts ...grpc.CallOption) (*ListAllInterfacesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/soominhyunwoo.base.reflection.v1beta1.ReflectionService/ListAllInterfaces", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reflectionServiceClient) ListImplementations(ctx context.Context, in *ListImplementationsRequest, opts ...grpc.CallOption) (*ListImplementationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/soominhyunwoo.base.reflection.v1beta1.ReflectionService/ListImplementations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReflectionService_ListAllInterfaces_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/soominhyunwoo.base.reflection.v1beta1.ReflectionService/ListAllInterfaces",
	}
...
func _ReflectionService_ListImplementations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/soominhyunwoo.base.reflection.v1beta1.ReflectionService/ListImplementations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ReflectionService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "soominhyunwoo.base.reflection.v1beta1.ReflectionService",
	...
	Metadata: "soominhyunwoo/base/reflection/v1beta1/reflection.proto",
}
