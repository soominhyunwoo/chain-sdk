...
simapp is an application built using the soominhyunwoo SDK for testing and educational purposes. 
...
1. `$ make build`. This will build the `simd` binary and install it in your soominhyunwoo SDK repo, 
...
Now you have a small testnet that you can use to try out changes to the soominhyunwoo SDK or Tendermint! 
