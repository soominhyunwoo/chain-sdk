...
import (
	...
	"github.com/soominhyunwoo/tendermint/crypto/tmhash"
...
func (app *BaseApp) cacheTxContext(ctx sdk.Context, txBytes []byte) (sdk.Context, sdk.CacheMultiStore) {
	ms := ctx.MultiStore()
	// TODO: https://github.com/soominhyunwoo/chain-sdk/issues/2824
...
func (app *BaseApp) runTx(mode runTxMode, txBytes []byte) (gInfo sdk.GasInfo, result *sdk.Result, err error) {
	...
	if app.anteHandler != nil {
		...
		// Ref: https://github.com/soominhyunwoo/chain-sdk/issues/2772
		//
