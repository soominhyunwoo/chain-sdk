...
import (
	...
	snapshottypes "github.com/soominhyunwoo/chain-sdk/snapshots/types"
	"github.com/soominhyunwoo/chain-sdk/store/rootmulti"
	store "github.com/soominhyunwoo/chain-sdk/store/types"
...
func registerTestCodec(cdc *codec.LegacyAmino) {
	...
	// register test types
	cdc.RegisterConcrete(&txTest{}, "soominhyunwoo-sdk/baseapp/txTest", nil)
	cdc.RegisterConcrete(&msgCounter{}, "soominhyunwoo-sdk/baseapp/msgCounter", nil)
	cdc.RegisterConcrete(&msgCounter2{}, "soominhyunwoo-sdk/baseapp/msgCounter2", nil)
	cdc.RegisterConcrete(&msgKeyValue{}, "soominhyunwoo-sdk/baseapp/msgKeyValue", nil)
	cdc.RegisterConcrete(&msgNoRoute{}, "soominhyunwoo-sdk/baseapp/msgNoRoute", nil)
}
...
func TestRunInvalidTransaction(t *testing.T) {
	...
	// Transaction with an unregistered message
	{
		...
		newCdc.RegisterConcrete(&msgNoDecode{}, "soominhyunwoo-sdk/baseapp/msgNoDecode", nil)
