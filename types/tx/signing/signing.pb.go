...
// source: soominhyunwoo/tx/signing/v1beta1/signing.proto
...
type SignatureDescriptor_Data_Single struct {
	...
	Mode SignMode `protobuf:"varint,1,opt,name=mode,proto3,enum=soominhyunwoo.tx.signing.v1beta1.SignMode" json:"mode,omitempty"`
...
func init() {
	proto.RegisterEnum("soominhyunwoo.tx.signing.v1beta1.SignMode", SignMode_name, SignMode_value)
	proto.RegisterType((*SignatureDescriptors)(nil), "soominhyunwoo.tx.signing.v1beta1.SignatureDescriptors")
	proto.RegisterType((*SignatureDescriptor)(nil), "soominhyunwoo.tx.signing.v1beta1.SignatureDescriptor")
	proto.RegisterType((*SignatureDescriptor_Data)(nil), "soominhyunwoo.tx.signing.v1beta1.SignatureDescriptor.Data")
	proto.RegisterType((*SignatureDescriptor_Data_Single)(nil), "soominhyunwoo.tx.signing.v1beta1.SignatureDescriptor.Data.Single")
	proto.RegisterType((*SignatureDescriptor_Data_Multi)(nil), "soominhyunwoo.tx.signing.v1beta1.SignatureDescriptor.Data.Multi")
}

func init() {
	proto.RegisterFile("soominhyunwoo/tx/signing/v1beta1/signing.proto", fileDescriptor_9a54958ff3d0b1b9)
}
