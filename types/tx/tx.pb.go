...
// source: soominhyunwoo/tx/v1beta1/tx.proto
...
import (
	...
	types1 "github.com/soominhyunwoo/chain-sdk/crypto/types"
	...
	signing "github.com/soominhyunwoo/chain-sdk/types/tx/signing"
...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/soominhyunwoo/chain-sdk/issues/9122).
...
type ModeInfo_Single struct {
	...
	Mode signing.SignMode `protobuf:"varint,1,opt,name=mode,proto3,enum=soominhyunwoo.tx.signing.v1beta1.SignMode" json:"mode,omitempty"`
}
...
func (m *Fee) GetAmount() github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
func init() {
	proto.RegisterType((*Tx)(nil), "soominhyunwoo.tx.v1beta1.Tx")
	proto.RegisterType((*TxRaw)(nil), "soominhyunwoo.tx.v1beta1.TxRaw")
	proto.RegisterType((*SignDoc)(nil), "soominhyunwoo.tx.v1beta1.SignDoc")
	proto.RegisterType((*TxBody)(nil), "soominhyunwoo.tx.v1beta1.TxBody")
	proto.RegisterType((*AuthInfo)(nil), "soominhyunwoo.tx.v1beta1.AuthInfo")
	proto.RegisterType((*SignerInfo)(nil), "soominhyunwoo.tx.v1beta1.SignerInfo")
	proto.RegisterType((*ModeInfo)(nil), "soominhyunwoo.tx.v1beta1.ModeInfo")
	proto.RegisterType((*ModeInfo_Single)(nil), "soominhyunwoo.tx.v1beta1.ModeInfo.Single")
	proto.RegisterType((*ModeInfo_Multi)(nil), "soominhyunwoo.tx.v1beta1.ModeInfo.Multi")
	proto.RegisterType((*Fee)(nil), "soominhyunwoo.tx.v1beta1.Fee")
}

func init() { proto.RegisterFile("soominhyunwoo/tx/v1beta1/tx.proto", fileDescriptor_96d1575ffde80842) }
