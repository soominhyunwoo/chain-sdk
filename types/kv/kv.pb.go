...
// source: soominhyunwoo/base/kv/v1beta1/kv.proto
...
func init() {
	proto.RegisterType((*Pairs)(nil), "soominhyunwoo.base.kv.v1beta1.Pairs")
	proto.RegisterType((*Pair)(nil), "soominhyunwoo.base.kv.v1beta1.Pair")
}

func init() { proto.RegisterFile("soominhyunwoo/base/kv/v1beta1/kv.proto", fileDescriptor_a44e87fe7182bb73) }
