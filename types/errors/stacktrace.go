...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/soominhyunwoo/chain-sdk/types/errors.Wrap",
		"github.com/soominhyunwoo/chain-sdk/types/errors.Wrapf",
		"github.com/soominhyunwoo/chain-sdk/types/errors.WithType",
