/*
Package simulation implements a full fledged soominhyunwoo SDK application used for executing
...
To execute a completely pseudo-random simulation:
 ...
 $ go test -mod=readonly github.com/soominhyunwoo/chain-sdk/simapp \
