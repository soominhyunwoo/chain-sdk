...
ICS20 uses the recommended acknowledgement format as specified by [ICS 04](https://github.com/soominhyunwoo/ics/tree/master/spec/ics-004-channel-and-packet-semantics#acknowledgement-envelope).
...
- **Relayer as a Service (RaaS)**: A longer term solution is to use/create a relayer service that
  ...
  public relayers (in [Golang](https://github.com/soominhyunwoo/relayer) and
