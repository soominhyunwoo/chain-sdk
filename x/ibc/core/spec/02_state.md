...
The paths for the values stored in state is defined [here](https://github.com/soominhyunwoo/ics/blob/master/spec/ics-024-host-requirements/README.md#path-space).
