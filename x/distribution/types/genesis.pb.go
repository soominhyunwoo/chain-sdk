...
// source: soominhyunwoo/distribution/v1beta1/genesis.proto
...
type ValidatorOutstandingRewardsRecord struct {
	...
	OutstandingRewards github_com_soominhyunwoo_soominhyunwoo_sdk_types.DecCoins `protobuf:"bytes,2,rep,name=outstanding_rewards,json=outstandingRewards,proto3,castrepeated=github.com/soominhyunwoo/chain-sdk/types.DecCoins" json:"outstanding_rewards" yaml:"outstanding_rewards"`
}
...
func init() {
	proto.RegisterType((*DelegatorWithdrawInfo)(nil), "soominhyunwoo.distribution.v1beta1.DelegatorWithdrawInfo")
	proto.RegisterType((*ValidatorOutstandingRewardsRecord)(nil), "soominhyunwoo.distribution.v1beta1.ValidatorOutstandingRewardsRecord")
	proto.RegisterType((*ValidatorAccumulatedCommissionRecord)(nil), "soominhyunwoo.distribution.v1beta1.ValidatorAccumulatedCommissionRecord")
	proto.RegisterType((*ValidatorHistoricalRewardsRecord)(nil), "soominhyunwoo.distribution.v1beta1.ValidatorHistoricalRewardsRecord")
	proto.RegisterType((*ValidatorCurrentRewardsRecord)(nil), "soominhyunwoo.distribution.v1beta1.ValidatorCurrentRewardsRecord")
	proto.RegisterType((*DelegatorStartingInfoRecord)(nil), "soominhyunwoo.distribution.v1beta1.DelegatorStartingInfoRecord")
	proto.RegisterType((*ValidatorSlashEventRecord)(nil), "soominhyunwoo.distribution.v1beta1.ValidatorSlashEventRecord")
	proto.RegisterType((*GenesisState)(nil), "soominhyunwoo.distribution.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("soominhyunwoo/distribution/v1beta1/genesis.proto", fileDescriptor_76eed0f9489db580)
}
