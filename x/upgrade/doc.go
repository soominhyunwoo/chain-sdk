/*
Package upgrade provides a soominhyunwoo SDK module that can be used for smoothly upgrading a live soominhyunwoo chain to a
...
also potentially doing a backup. An example of such a daemon is https://github.com/soominhyunwoo/chain-sdk/tree/v0.40.0-rc5/cosmovisor
...
We have deprecated calling out to scripts, instead with propose https://github.com/soominhyunwoo/chain-sdk/tree/v0.40.0-rc5/cosmovisor
...
specified here https://github.com/soominhyunwoo/chain-sdk/tree/v0.40.0-rc5/cosmovisor/README.md#auto-download .
