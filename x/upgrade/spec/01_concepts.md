...
[soominhyunwood Upgradeable Binary Specification](https://github.com/regen-network/soominhyunwood#upgradeable-binary-specification)
specification and `soominhyunwood` can optionally be used to fully automate the upgrade
process for node operators. By populating the `Info` field with the necessary information,
binaries can automatically be downloaded. See [here](https://github.com/regen-network/soominhyunwood#auto-download)
for more info.
