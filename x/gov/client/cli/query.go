...
import (
	...
	gcutils "github.com/soominhyunwoo/chain-sdk/x/gov/client/utils"
...
Example:
$ %s query gov proposals --depositor soominhyunwoo1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
$ %s query gov proposals --voter soominhyunwoo1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
...
Example:
$ %s query gov vote 1 soominhyunwoo1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
`,
				version.AppName,
			),
		),
...
Example:
$ %s query gov deposit 1 soominhyunwoo1skjwj5whet0lpe65qaq4rpq03hjxlwd9nf39lk
`,
				version.AppName,
			),
		),
