...
This paper specifies the Governance module of the soominhyunwoo-SDK, which was first
described in the [soominhyunwoo Whitepaper](https://soominhyunwoo.network/about/whitepaper) in
June 2016.

The module enables soominhyunwoo-SDK based blockchain to support an on-chain governance
...
This module will be used in the soominhyunwoo Hub, the first Hub in the soominhyunwoo network.
