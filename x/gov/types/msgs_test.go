...
func TestMsgDepositGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"soominhyunwoo-sdk/MsgDeposit","value":{"amount":[{"amount":"1000","denom":"stake"}],"depositor":"soominhyunwoo1v9jxgu33kfsgr5","proposal_id":"0"}}`
...
func TestMsgSubmitProposal_GetSignBytes(t *testing.T) {
	...
	require.Equal(t,
		`{"type":"soominhyunwoo-sdk/MsgSubmitProposal","value":{"content":{"type":"soominhyunwoo-sdk/TextProposal","value":{"description":"abcd","title":"test"}},"initial_deposit":[]}}`,
		string(bz))
}
