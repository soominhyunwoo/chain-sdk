...
// source: soominhyunwoo/gov/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "soominhyunwoo.gov.v1beta1.GenesisState")
}

func init() { proto.RegisterFile("soominhyunwoo/gov/v1beta1/genesis.proto", fileDescriptor_43cd825e0fa7a627) }
