...
func (s *IntegrationTestSuite) TestCLIQueryTxCmd() {
	...
	testCases := []struct {
		...
		},
		{
			...
			false,
			"/soominhyunwoo.bank.v1beta1.MsgSend",
		},
	}
...
func TestGetBroadcastCommandWithoutOfflineFlag(t *testing.T) {
	...
	from, err := sdk.AccAddressFromBech32("soominhyunwoo1cxlt8kznps92fwu3j6npahx4mjfutydyene2qw")
	require.NoError(t, err)
	to, err := sdk.AccAddressFromBech32("soominhyunwoo1cxlt8kznps92fwu3j6npahx4mjfutydyene2qw")
	require.NoError(t, err)
...
// See https://github.com/soominhyunwoo/chain-sdk/issues/7585 for more details.
