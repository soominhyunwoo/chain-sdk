...
// source: soominhyunwoo/auth/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "soominhyunwoo.auth.v1beta1.GenesisState")
}

func init() { proto.RegisterFile("soominhyunwoo/auth/v1beta1/genesis.proto", fileDescriptor_d897ccbce9822332) }
