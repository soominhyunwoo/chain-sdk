...
// source: soominhyunwoo/auth/v1beta1/auth.proto
...
func init() {
	proto.RegisterType((*BaseAccount)(nil), "soominhyunwoo.auth.v1beta1.BaseAccount")
	proto.RegisterType((*ModuleAccount)(nil), "soominhyunwoo.auth.v1beta1.ModuleAccount")
	proto.RegisterType((*Params)(nil), "soominhyunwoo.auth.v1beta1.Params")
}

func init() {
	proto.RegisterFile("soominhyunwoo/auth/v1beta1/auth.proto", fileDescriptor_7e1f7e915d020d2d)
}
