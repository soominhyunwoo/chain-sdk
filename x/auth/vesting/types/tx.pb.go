...
// source: soominhyunwoo/vesting/v1beta1/tx.proto
...
func (m *MsgCreateVestingAccount) GetAmount() github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins {
	if m != nil {
		return m.Amount
	}
	return nil
...
func init() {
	proto.RegisterType((*MsgCreateVestingAccount)(nil), "soominhyunwoo.vesting.v1beta1.MsgCreateVestingAccount")
	proto.RegisterType((*MsgCreateVestingAccountResponse)(nil), "soominhyunwoo.vesting.v1beta1.MsgCreateVestingAccountResponse")
}

func init() { proto.RegisterFile("soominhyunwoo/vesting/v1beta1/tx.proto", fileDescriptor_5338ca97811f9792) }
...
func (c *msgClient) CreateVestingAccount(ctx context.Context, in *MsgCreateVestingAccount, opts ...grpc.CallOption) (*MsgCreateVestingAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/soominhyunwoo.vesting.v1beta1.Msg/CreateVestingAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateVestingAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/soominhyunwoo.vesting.v1beta1.Msg/CreateVestingAccount",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "soominhyunwoo.vesting.v1beta1.Msg",
	...
	Metadata: "soominhyunwoo/vesting/v1beta1/tx.proto",
}
