...
// source: soominhyunwoo/capability/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisOwners)(nil), "soominhyunwoo.capability.v1beta1.GenesisOwners")
	proto.RegisterType((*GenesisState)(nil), "soominhyunwoo.capability.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("soominhyunwoo/capability/v1beta1/genesis.proto", fileDescriptor_94922dd16a11c23e)
}
