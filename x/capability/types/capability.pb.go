...
// source: soominhyunwoo/capability/v1beta1/capability.proto
...
func init() {
	proto.RegisterType((*Capability)(nil), "soominhyunwoo.capability.v1beta1.Capability")
	proto.RegisterType((*Owner)(nil), "soominhyunwoo.capability.v1beta1.Owner")
	proto.RegisterType((*CapabilityOwners)(nil), "soominhyunwoo.capability.v1beta1.CapabilityOwners")
}

func init() {
	proto.RegisterFile("soominhyunwoo/capability/v1beta1/capability.proto", fileDescriptor_6308261edd8470a9)
}
