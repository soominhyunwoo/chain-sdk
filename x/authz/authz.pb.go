...
// source: soominhyunwoo/authz/v1beta1/authz.proto
...
func init() {
	proto.RegisterType((*GenericAuthorization)(nil), "soominhyunwoo.authz.v1beta1.GenericAuthorization")
	proto.RegisterType((*Grant)(nil), "soominhyunwoo.authz.v1beta1.Grant")
}

func init() {
	proto.RegisterFile("soominhyunwoo/authz/v1beta1/authz.proto", fileDescriptor_544dc2e84b61c637)
}
