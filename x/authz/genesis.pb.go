...
// source: soominhyunwoo/authz/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "soominhyunwoo.authz.v1beta1.GenesisState")
	proto.RegisterType((*GrantAuthorization)(nil), "soominhyunwoo.authz.v1beta1.GrantAuthorization")
}

func init() {
	proto.RegisterFile("soominhyunwoo/authz/v1beta1/genesis.proto", fileDescriptor_4c2fbb971da7c892)
}
