...
// source: soominhyunwoo/authz/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgGrant)(nil), "soominhyunwoo.authz.v1beta1.MsgGrant")
	proto.RegisterType((*MsgExecResponse)(nil), "soominhyunwoo.authz.v1beta1.MsgExecResponse")
	proto.RegisterType((*MsgExec)(nil), "soominhyunwoo.authz.v1beta1.MsgExec")
	proto.RegisterType((*MsgGrantResponse)(nil), "soominhyunwoo.authz.v1beta1.MsgGrantResponse")
	proto.RegisterType((*MsgRevoke)(nil), "soominhyunwoo.authz.v1beta1.MsgRevoke")
	proto.RegisterType((*MsgRevokeResponse)(nil), "soominhyunwoo.authz.v1beta1.MsgRevokeResponse")
}

func init() {
	proto.RegisterFile("soominhyunwoo/authz/v1beta1/tx.proto", fileDescriptor_3ceddab7d8589ad1)
}
...
func (c *msgClient) Grant(ctx context.Context, in *MsgGrant, opts ...grpc.CallOption) (*MsgGrantResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/soominhyunwoo.authz.v1beta1.Msg/Grant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Exec(ctx context.Context, in *MsgExec, opts ...grpc.CallOption) (*MsgExecResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/soominhyunwoo.authz.v1beta1.Msg/Exec", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Revoke(ctx context.Context, in *MsgRevoke, opts ...grpc.CallOption) (*MsgRevokeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/soominhyunwoo.authz.v1beta1.Msg/Revoke", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Grant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/soominhyunwoo.authz.v1beta1.Msg/Grant",
	}
...
func _Msg_Exec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/soominhyunwoo.authz.v1beta1.Msg/Exec",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_Revoke_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/soominhyunwoo.authz.v1beta1.Msg/Revoke",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "soominhyunwoo.authz.v1beta1.Msg",
	...
	Metadata: "soominhyunwoo/authz/v1beta1/tx.proto",
}
