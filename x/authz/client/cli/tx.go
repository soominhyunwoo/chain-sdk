...
import (
	...
	staking "github.com/soominhyunwoo/chain-sdk/x/staking/types"
)
...
Examples:
 $ %s tx %s grant soominhyunwoo1skjw.. send %s --spend-limit=1000stake --from=soominhyunwoo1skl..
 $ %s tx %s grant soominhyunwoo1skjw.. generic --msg-type=/soominhyunwoo.gov.v1beta1.MsgVote --from=soominhyunwoo1sk..
...
Example:
 $ %s tx %s revoke soominhyunwoo1skj.. %s --from=soominhyunwoo1skj..
