...
var (
	pattern_Query_Grants_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"soominhyunwoo", "authz", "v1beta1", "grants"}, "", runtime.AssumeColonVerbOpt(false)))
)
