...
// source: soominhyunwoo/authz/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryGrantsRequest)(nil), "soominhyunwoo.authz.v1beta1.QueryGrantsRequest")
	proto.RegisterType((*QueryGrantsResponse)(nil), "soominhyunwoo.authz.v1beta1.QueryGrantsResponse")
}

func init() { proto.RegisterFile("soominhyunwoo/authz/v1beta1/query.proto", fileDescriptor_376d714ffdeb1545) }
...
func (c *queryClient) Grants(ctx context.Context, in *QueryGrantsRequest, opts ...grpc.CallOption) (*QueryGrantsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/soominhyunwoo.authz.v1beta1.Query/Grants", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Grants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/soominhyunwoo.authz.v1beta1.Query/Grants",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "soominhyunwoo.authz.v1beta1.Query",
	...
	Metadata: "soominhyunwoo/authz/v1beta1/query.proto",
}
