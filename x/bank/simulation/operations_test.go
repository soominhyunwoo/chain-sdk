...
import (
	...
	"github.com/soominhyunwoo/chain-sdk/x/bank/simulation"
...
func (suite *SimTestSuite) TestSimulateMsgSend() {
	...
	suite.Require().Equal("soominhyunwoo1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.FromAddress)
	suite.Require().Equal("soominhyunwoo1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7u4x9a0", msg.ToAddress)
...
func (suite *SimTestSuite) TestSimulateMsgMultiSend() {
	...
	require.Equal("soominhyunwoo1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7u4x9a0", msg.Inputs[1].Address)
	require.Equal("185121068stake", msg.Inputs[1].Coins.String())
	require.Len(msg.Outputs, 2)
	require.Equal("soominhyunwoo1ghekyjucln7y67ntx7cf27m9dpuxxemn4c8g4r", msg.Outputs[1].Address)
