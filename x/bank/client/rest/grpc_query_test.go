...
func (s *IntegrationTestSuite) TestTotalSupplyGRPCHandler() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/soominhyunwoo/bank/v1beta1/supply", baseURL),
			map[string]string{
		...
		},
		{
			...
			fmt.Sprintf("%s/soominhyunwoo/bank/v1beta1/supply/%s", baseURL, s.cfg.BondDenom),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "1",
			},
		...
		},
		{
			...
			fmt.Sprintf("%s/soominhyunwoo/bank/v1beta1/supply/%s?height=2", baseURL, s.cfg.BondDenom),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "1",
			},
			&types.QuerySupplyOfResponse{},
		...
		},
		{
			...
			fmt.Sprintf("%s/soominhyunwoo/bank/v1beta1/supply/foobar", baseURL),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "1",
			},
			&types.QuerySupplyOfResponse{},
...
func (s *IntegrationTestSuite) TestDenomMetadataGRPCHandler() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/soominhyunwoo/bank/v1beta1/denoms_metadata", baseURL),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "1",
			},
			false,
			...
			&types.QueryDenomsMetadataResponse{
				Metadatas: []types.Metadata{
					{
						Name:        "soominhyunwoo Hub Atom",
						Symbol:      "ATOM",
						Description: "The native staking token of the soominhyunwoo Hub.",
		...
		},
		{
			...
			fmt.Sprintf("%s/soominhyunwoo/bank/v1beta1/denoms_metadata/uatom", baseURL),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "1",
			},
			false,
		...
		},
		{
			...
			fmt.Sprintf("%s/soominhyunwoo/bank/v1beta1/denoms_metadata/foobar", baseURL),
			map[string]string{
				grpctypes.GRPCBlockHeightHeader: "1",
			},
			true,
...
func (s *IntegrationTestSuite) TestBalancesGRPCHandler() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			fmt.Sprintf("%s/soominhyunwoo/bank/v1beta1/balances/%s", baseURL, val.Address.String()),
		...
		},
		{
			...
			fmt.Sprintf("%s/soominhyunwoo/bank/v1beta1/balances/%s/%s", baseURL, val.Address.String(), s.cfg.BondDenom),
		...
		},
		{
			...
			fmt.Sprintf("%s/soominhyunwoo/bank/v1beta1/balances/%s/foobar", baseURL, val.Address.String()),
			&types.QueryBalanceResponse{},
			&types.QueryBalanceResponse{
				Balance: &sdk.Coin{
					Denom:  "foobar",
