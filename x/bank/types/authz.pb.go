...
// source: soominhyunwoo/bank/v1beta1/authz.proto
...
func (m *SendAuthorization) GetSpendLimit() github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins {
	if m != nil {
		return m.SpendLimit
	}
	return nil
...
func init() {
	proto.RegisterType((*SendAuthorization)(nil), "soominhyunwoo.bank.v1beta1.SendAuthorization")
}

func init() {
	proto.RegisterFile("soominhyunwoo/bank/v1beta1/authz.proto", fileDescriptor_a4d2a37888ea779f)
}
