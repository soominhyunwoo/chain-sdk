...
// source: soominhyunwoo/bank/v1beta1/genesis.proto
...
type GenesisState struct {
	...
	Supply github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins `protobuf:"bytes,3,rep,name=supply,proto3,castrepeated=github.com/soominhyunwoo/chain-sdk/types.Coins" json:"supply"`
...
func (m *GenesisState) GetSupply() github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins {
	if m != nil {
		return m.Supply
	}
	return nil
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "soominhyunwoo.bank.v1beta1.GenesisState")
	proto.RegisterType((*Balance)(nil), "soominhyunwoo.bank.v1beta1.Balance")
}

func init() { proto.RegisterFile("soominhyunwoo/bank/v1beta1/genesis.proto", fileDescriptor_8f007de11b420c6e) }
