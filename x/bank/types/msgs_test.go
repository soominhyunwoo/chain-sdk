...
func TestMsgSendGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"soominhyunwoo-sdk/MsgSend","value":{"amount":[{"amount":"10","denom":"atom"}],"from_address":"soominhyunwoo1d9h8qat57ljhcm","to_address":"soominhyunwoo1da6hgur4wsmpnjyg"}}`
...
func TestMsgMultiSendGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"soominhyunwoo-sdk/MsgMultiSend","value":{"inputs":[{"address":"soominhyunwoo1d9h8qat57ljhcm","coins":[{"amount":"10","denom":"atom"}]}],"outputs":[{"address":"soominhyunwoo1da6hgur4wsmpnjyg","coins":[{"amount":"10","denom":"atom"}]}]}}`
	require.Equal(t, expected, string(res))
}
