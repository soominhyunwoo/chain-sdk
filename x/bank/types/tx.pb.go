...
// source: soominhyunwoo/bank/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgSend)(nil), "soominhyunwoo.bank.v1beta1.MsgSend")
	proto.RegisterType((*MsgSendResponse)(nil), "soominhyunwoo.bank.v1beta1.MsgSendResponse")
	proto.RegisterType((*MsgMultiSend)(nil), "soominhyunwoo.bank.v1beta1.MsgMultiSend")
	proto.RegisterType((*MsgMultiSendResponse)(nil), "soominhyunwoo.bank.v1beta1.MsgMultiSendResponse")
}

func init() { proto.RegisterFile("soominhyunwoo/bank/v1beta1/tx.proto", fileDescriptor_1d8cb1613481f5b7) }
...
func (c *msgClient) Send(ctx context.Context, in *MsgSend, opts ...grpc.CallOption) (*MsgSendResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/soominhyunwoo.bank.v1beta1.Msg/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) MultiSend(ctx context.Context, in *MsgMultiSend, opts ...grpc.CallOption) (*MsgMultiSendResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/soominhyunwoo.bank.v1beta1.Msg/MultiSend", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/soominhyunwoo.bank.v1beta1.Msg/Send",
	}
...
func _Msg_MultiSend_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/soominhyunwoo.bank.v1beta1.Msg/MultiSend",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "soominhyunwoo.bank.v1beta1.Msg",
	...
	Metadata: "soominhyunwoo/bank/v1beta1/tx.proto",
}
