...
// source: soominhyunwoo/bank/v1beta1/bank.proto
...
type Input struct {
	...
	Coins   github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins `protobuf:"bytes,2,rep,name=coins,proto3,castrepeated=github.com/soominhyunwoo/chain-sdk/types.Coins" json:"coins"`
}
...
type Supply struct {
	Total github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins `protobuf:"bytes,1,rep,name=total,proto3,castrepeated=github.com/soominhyunwoo/chain-sdk/types.Coins" json:"total"`
}
...
type Metadata struct {
	...
	// name defines the name of the token (eg: soominhyunwoo Atom)
...
func init() {
	proto.RegisterType((*Params)(nil), "soominhyunwoo.bank.v1beta1.Params")
	proto.RegisterType((*SendEnabled)(nil), "soominhyunwoo.bank.v1beta1.SendEnabled")
	proto.RegisterType((*Input)(nil), "soominhyunwoo.bank.v1beta1.Input")
	proto.RegisterType((*Output)(nil), "soominhyunwoo.bank.v1beta1.Output")
	proto.RegisterType((*Supply)(nil), "soominhyunwoo.bank.v1beta1.Supply")
	proto.RegisterType((*DenomUnit)(nil), "soominhyunwoo.bank.v1beta1.DenomUnit")
	proto.RegisterType((*Metadata)(nil), "soominhyunwoo.bank.v1beta1.Metadata")
}

func init() {
	proto.RegisterFile("soominhyunwoo/bank/v1beta1/bank.proto", fileDescriptor_dd052eee12edf988)
}
