...
// source: soominhyunwoo/feegrant/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "soominhyunwoo.feegrant.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("soominhyunwoo/feegrant/v1beta1/genesis.proto", fileDescriptor_ac719d2d0954d1bf)
}
