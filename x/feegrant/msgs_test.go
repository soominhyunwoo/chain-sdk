...
func TestMsgGrantAllowance(t *testing.T) {
	...
	addr, _ := sdk.AccAddressFromBech32("soominhyunwoo1aeuqja06474dfrj7uqsvukm6rael982kk89mqr")
	addr2, _ := sdk.AccAddressFromBech32("soominhyunwoo1nph3cfzk6trsmfxkeu943nvach5qw4vwstnvkl")
