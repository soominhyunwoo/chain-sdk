...
func TestGrant(t *testing.T) {
	...
	addr, err := sdk.AccAddressFromBech32("soominhyunwoo1qk93t4j0yyzgqgt6k5qf8deh8fq6smpn3ntu3x")
	require.NoError(t, err)
	addr2, err := sdk.AccAddressFromBech32("soominhyunwoo1p9qh4ldfd6n0qehujsal4k7g0e37kel90rc4ts")
	require.NoError(t, err)
