...
// source: soominhyunwoo/feegrant/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgGrantAllowance)(nil), "soominhyunwoo.feegrant.v1beta1.MsgGrantAllowance")
	proto.RegisterType((*MsgGrantAllowanceResponse)(nil), "soominhyunwoo.feegrant.v1beta1.MsgGrantAllowanceResponse")
	proto.RegisterType((*MsgRevokeAllowance)(nil), "soominhyunwoo.feegrant.v1beta1.MsgRevokeAllowance")
	proto.RegisterType((*MsgRevokeAllowanceResponse)(nil), "soominhyunwoo.feegrant.v1beta1.MsgRevokeAllowanceResponse")
}

func init() {
	proto.RegisterFile("soominhyunwoo/feegrant/v1beta1/tx.proto", fileDescriptor_dd44ad7946dad783)
}
...
func (c *msgClient) GrantAllowance(ctx context.Context, in *MsgGrantAllowance, opts ...grpc.CallOption) (*MsgGrantAllowanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/soominhyunwoo.feegrant.v1beta1.Msg/GrantAllowance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RevokeAllowance(ctx context.Context, in *MsgRevokeAllowance, opts ...grpc.CallOption) (*MsgRevokeAllowanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/soominhyunwoo.feegrant.v1beta1.Msg/RevokeAllowance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_GrantAllowance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/soominhyunwoo.feegrant.v1beta1.Msg/GrantAllowance",
	}
...
func _Msg_RevokeAllowance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/soominhyunwoo.feegrant.v1beta1.Msg/RevokeAllowance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "soominhyunwoo.feegrant.v1beta1.Msg",
	...
	Metadata: "soominhyunwoo/feegrant/v1beta1/tx.proto",
}
