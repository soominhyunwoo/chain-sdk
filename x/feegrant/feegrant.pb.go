...
// source: soominhyunwoo/feegrant/v1beta1/feegrant.proto
...
type BasicAllowance struct {
	...
	SpendLimit github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins `protobuf:"bytes,1,rep,name=spend_limit,json=spendLimit,proto3,castrepeated=github.com/soominhyunwoo/chain-sdk/types.Coins" json:"spend_limit"`
...
func (m *BasicAllowance) GetSpendLimit() github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins {
	if m != nil {
		return m.SpendLimit
	}
	return nil
...
type PeriodicAllowance struct {
	...
	// in the period
	PeriodSpendLimit github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins `protobuf:"bytes,3,rep,name=period_spend_limit,json=periodSpendLimit,proto3,castrepeated=github.com/soominhyunwoo/chain-sdk/types.Coins" json:"period_spend_limit"`
	// period_can_spend is the number of coins left to be spent before the period_reset time
	PeriodCanSpend github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins `protobuf:"bytes,4,rep,name=period_can_spend,json=periodCanSpend,proto3,castrepeated=github.com/soominhyunwoo/chain-sdk/types.Coins" json:"period_can_spend"`
...
func (m *PeriodicAllowance) GetPeriodSpendLimit() github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins {
	if m != nil {
...
func (m *PeriodicAllowance) GetPeriodCanSpend() github_com_soominhyunwoo_soominhyunwoo_sdk_types.Coins {
	if m != nil {
...
func init() {
	proto.RegisterType((*BasicAllowance)(nil), "soominhyunwoo.feegrant.v1beta1.BasicAllowance")
	proto.RegisterType((*PeriodicAllowance)(nil), "soominhyunwoo.feegrant.v1beta1.PeriodicAllowance")
	proto.RegisterType((*AllowedMsgAllowance)(nil), "soominhyunwoo.feegrant.v1beta1.AllowedMsgAllowance")
	proto.RegisterType((*Grant)(nil), "soominhyunwoo.feegrant.v1beta1.Grant")
}

func init() {
	proto.RegisterFile("soominhyunwoo/feegrant/v1beta1/feegrant.proto", fileDescriptor_7279582900c30aea)
}
