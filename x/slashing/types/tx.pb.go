...
// source: soominhyunwoo/slashing/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgUnjail)(nil), "soominhyunwoo.slashing.v1beta1.MsgUnjail")
	proto.RegisterType((*MsgUnjailResponse)(nil), "soominhyunwoo.slashing.v1beta1.MsgUnjailResponse")
}

func init() { proto.RegisterFile("soominhyunwoo/slashing/v1beta1/tx.proto", fileDescriptor_3c5611c0c4a59d9d) }
...
func (c *msgClient) Unjail(ctx context.Context, in *MsgUnjail, opts ...grpc.CallOption) (*MsgUnjailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/soominhyunwoo.slashing.v1beta1.Msg/Unjail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Unjail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/soominhyunwoo.slashing.v1beta1.Msg/Unjail",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "soominhyunwoo.slashing.v1beta1.Msg",
	...
	Metadata: "soominhyunwoo/slashing/v1beta1/tx.proto",
}
