...
// source: soominhyunwoo/evidence/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "soominhyunwoo.evidence.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("soominhyunwoo/evidence/v1beta1/genesis.proto", fileDescriptor_c610c52c26e0e202)
}
