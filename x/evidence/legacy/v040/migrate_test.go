...
func TestMigrate(t *testing.T) {
	...
	expected := `{"evidence":[{"@type":"/soominhyunwoo.evidence.v1beta1.Equivocation","height":"20","time":"0001-01-01T00:00:00Z","power":"100","consensus_address":"soominhyunwoovalcons1xxkueklal9vejv9unqu80w9vptyepfa99x2a3w"}]}`
