...
[Evidence](https://github.com/soominhyunwoo/tendermint/blob/master/docs/spec/blockchain/blockchain.md#evidence),
...
on slashing and jailing can be found in the [x/staking spec](/.././soominhyunwoo-sdk/x/staking/spec/02_state_transitions.md)
