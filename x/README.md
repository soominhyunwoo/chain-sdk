...
Here are some production-grade modules that can be used in soominhyunwoo SDK applications, along with their respective documentation:

- [Auth](auth/spec/README.md) - Authentication of accounts and transactions for soominhyunwoo SDK application.
...
The IBC module for the SDK has moved to its [own repository](https://github.com/soominhyunwoo/ibc-go). 
