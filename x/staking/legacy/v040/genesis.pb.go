...
// https://github.com/soominhyunwoo/chain-sdk/blob/v0.40.1/x/staking/types/genesis.pb.go
...
import (
	...
	github_com_soominhyunwoo_soominhyunwoo_sdk_types "github.com/soominhyunwoo/chain-sdk/types"
...
type GenesisState struct {
	...
	LastTotalPower github_com_soominhyunwoo_soominhyunwoo_sdk_types.Int `protobuf:"bytes,2,opt,name=last_total_power,json=lastTotalPower,proto3,customtype=github.com/soominhyunwoo/chain-sdk/types.Int" json:"last_total_power" yaml:"last_total_power"`
...
func init() {
	// proto.RegisterType((*GenesisState)(nil), "soominhyunwoo.staking.v1beta1.GenesisState")
	// proto.RegisterType((*LastValidatorPower)(nil), "soominhyunwoo.staking.v1beta1.LastValidatorPower")
}

func init() {
	// proto.RegisterFile("soominhyunwoo/staking/v1beta1/genesis.proto", fileDescriptor_9b3dec8894f2831b)
}
