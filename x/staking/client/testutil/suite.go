...
import (
	...
	"github.com/soominhyunwoo/tendermint/proto/tendermint/crypto"
	"github.com/soominhyunwoo/tendermint/rpc/client/http"
...
func (s *IntegrationTestSuite) TestGetCmdQueryValidator() {
	...
	testCases := []struct {
		...
		},
		{
			...
			[]string{"soominhyunwoovaloper15jkng8hytwt22lllv6mw4k89qkqehtahd84ptu", fmt.Sprintf("--%s=json", tmcli.OutputFlag)},
			true,
		},
		{
			"happy case",
...
func (s *IntegrationTestSuite) TestNewRedelegateCmd() {
	...
	testCases := []struct {
		...
		},
		{
			...
			[]string{
				`soominhyunwoovaloper1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj`, // src-validator-addr
				val2.ValAddress.String(),                               // dst-validator-addr
...
// ref: https://github.com/soominhyunwoo/chain-sdk/issues/7401.
