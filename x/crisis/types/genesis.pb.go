...
// source: soominhyunwoo/crisis/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "soominhyunwoo.crisis.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("soominhyunwoo/crisis/v1beta1/genesis.proto", fileDescriptor_7a9c2781aa8a27ae)
}
