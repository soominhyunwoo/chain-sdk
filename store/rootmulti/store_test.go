...
import (
	...
	sdkmaps "github.com/soominhyunwoo/chain-sdk/store/internal/maps"
...
func benchmarkMultistoreSnapshot(b *testing.B, stores uint8, storeKeys uint64) {
	b.Skip("Noisy with slow setup time, please see https://github.com/soominhyunwoo/chain-sdk/issues/8855.")
