...
// source: soominhyunwoo/base/store/v1beta1/snapshot.proto
...
func init() {
	proto.RegisterType((*SnapshotItem)(nil), "soominhyunwoo.base.store.v1beta1.SnapshotItem")
	proto.RegisterType((*SnapshotStoreItem)(nil), "soominhyunwoo.base.store.v1beta1.SnapshotStoreItem")
	proto.RegisterType((*SnapshotIAVLItem)(nil), "soominhyunwoo.base.store.v1beta1.SnapshotIAVLItem")
}

func init() {
	proto.RegisterFile("soominhyunwoo/base/store/v1beta1/snapshot.proto", fileDescriptor_9c55879db4cc4502)
}
