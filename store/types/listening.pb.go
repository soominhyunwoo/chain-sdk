...
// source: soominhyunwoo/base/store/v1beta1/listening.proto
...
func init() {
	proto.RegisterType((*StoreKVPair)(nil), "soominhyunwoo.base.store.v1beta1.StoreKVPair")
}

func init() {
	proto.RegisterFile("soominhyunwoo/base/store/v1beta1/listening.proto", fileDescriptor_a5d350879fe4fecd)
}
